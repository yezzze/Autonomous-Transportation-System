...
# CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node= 2 opencood/tools/train_ddp.py

# CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 opencood/tools/train_ddp.py
...
def train_parser():
    ...
    parser.add_argument("--hypes_yaml", "-y", default="opencood/logs/m4_collab_25600_0.4/config.yaml", type=str, required=False, help="data generation yaml file needed ")
    parser.add_argument("--model_dir", default="opencood/logs/m4_collab_25600_0.4", help="Continued training path")  #多车

     #parser.add_argument("--model_dir", default="opencood/logs/m4_single_25600", help="Continued training path")     #单车
...
def main():
    ...
    for epoch in range(init_epoch, max(epoches, init_epoch)):
        ...
        ###
        print(f"--- Epoch {epoch} Data Loading Start ---")
        
        for i, batch_data in enumerate(train_loader):
            
            ###
            if i % 10 == 0:
                print(f"Epoch {epoch} | Iteration {i} | Processing...")

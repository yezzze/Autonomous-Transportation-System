...
def train_parser():
    ...
    #parser.add_argument("--model_dir", default="opencood/logs/m4_single_12800", help="Continued training path")  #多车

    parser.add_argument("--model_dir", default="opencood/logs/m4_single_12800", help="Continued training path")     #单车
...
def main():
    ...
    # 仅在主进程 (rank 0) 中执行，避免多个进程同时写入同一个文件
    # --------------------------------------------------------------------------------

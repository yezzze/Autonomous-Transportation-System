...
class VoxelPostprocessor(BasePostprocessor):
    ...
    def post_process(self, data_dict, output_dict):
        ...
        for cav_id, cav_content in data_dict.items():
            ...
            # rename variable 
            if 'cls_preds' in output_dict[cav_id]:
                output_dict[cav_id]['psm'] = output_dict[cav_id]['cls_preds']
            if 'reg_preds' in output_dict[cav_id]:
                output_dict[cav_id]['rm'] = output_dict[cav_id]['reg_preds']
            if 'dir_preds' in output_dict[cav_id]:
                output_dict[cav_id]['dm'] = output_dict[cav_id]['dir_preds']

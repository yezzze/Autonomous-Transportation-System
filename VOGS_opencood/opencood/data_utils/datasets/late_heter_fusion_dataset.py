    ...
    class LateheterFusionDataset(cls):
        ...
        def get_item_single_car(self, selected_cav_base):
            ...
            object_bbx_center, object_bbx_mask, object_ids = self.generate_object_center_single(
                cav_contents=[selected_cav_base], reference_lidar_pose=selected_cav_base["params"]["lidar_pose_clean"]
            )
            ...
            #co3
            voxel_label_co3sop_256 = selected_cav_base.get('occ_co3sop_256_single', None) # for single agent training
            ...
            label_dict = self.post_processor.generate_label(
                ...
                voxel_label_co3sop=voxel_label_co3sop_256 if voxel_label_co3sop_256 is not None else None,
                label_mapping=label_mapping_co3sop if voxel_label_co3sop_256 is not None else None,
            )
        ...
        def collate_batch_train(self, batch):
            ...
            # Flatten label_dict to top level for compatibility with lifter modules
        ...
        def collate_batch_test(self, batch):
            ...
            for cav_id, cav_content in batch.items():
                ...
                # Flatten label_dict to top level for compatibility with lifter modules
                output_dict[cav_id].update(label_torch_dict)

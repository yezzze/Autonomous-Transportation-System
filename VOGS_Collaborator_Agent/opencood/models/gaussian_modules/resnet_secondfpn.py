...
try:
    ...
    from mmdet3d.models import builder as mmdet3dMODELS # Fallback or different version check
...
class ResNetSecondFPN(nn.Module):
    def __init__(
        ...
        # mmdet3dMODELS might be a registry or builder. 
        # In original code: from mmdet3d.registry import MODELS as mmdet3dMODELS; mmdet3dMODELS.build(neck_confifg)
        # We keep using it assuming mmdet3d is installed.
